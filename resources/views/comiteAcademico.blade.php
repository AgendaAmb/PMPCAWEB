            ...
            <div class="accordion-item">
                ...
                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                    ...
                    <div class="accordion-body">
                        ...
                        <p><strong id="nameProf">Dr. Antonio Cardona Benavides</strong> <br> Titular y Coordinador de
                            área<br></p>
                        ...
                        <p><strong id="nameProf">Dra. Anuschka Van´t Hooft</strong> <br> Titular y Coordinador de área<br>
                        </p>
                        ...
                        <p><strong id="nameProf">Dra. Paola Elizabeth Díaz Flores</strong> <br>Coordinadora Académica y
                            Titular<br></p>
                        <p><strong id="nameProf">Dr. Israel Rodríguez Torres</strong> <br>Titular y Coordinador de área<br>
                        </p>
                        ...
                        <p><strong id="nameProf">Dr. José Antonio Ávalos Lozano</strong> <br>Titular y Coordinador de
                            área<br></p>
    ...
    <div id="p-container" class="container px-lg-8.5 px-md-5">
        <div id="professor-description" class="row mb-4 p-5">
            ...
            <div class="col-12 col-sm-12" id="enlacesNormativa">
                <div>
                    <a target="_blank" href="storage/Doc/Reglamentoposgrado.pdf"> <strong>- Reglamento General de Estudios
                            de Posgrado</strong></a>
                    <br><br>
                    <a target="_blank" href="storage/Doc/PMCA_PropuestaGral.pdf"> <strong>- Propuesta para la creación del
                            Programa Multidisciplinario de Posgrado
                            en Ciencias Ambientales</strong>
                        <br><br>
                        <a target="_blank" href="storage/Doc/PMPCA_ReglamentoDoctorado.pdf"> <strong>- Reglamentos del PMPCA
                                - Doctorado</strong> </a>
                        <br><br>
                        <a target="_blank" href="storage/Doc/PMPCA_ReglamentoMaestria.pdf"> <strong>- Reglamentos del PMPCA
                                - Maestría</strong></a>
                        <br><br>
                        <a target="_blank" href="storage/Doc/SistemaIntAseguramientoCalidad.pdf"> <strong>- Sistema Interno
