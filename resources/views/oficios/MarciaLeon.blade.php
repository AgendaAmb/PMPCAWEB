...
<div id="p-container" class="container px-lg-8.5 px-md-5">
    ...
    <div class="col-12 col-sm-12">
        ...
        <div class="col-12 col-sm-12 p-5 img-fluid">
          <p align="right"><a href="{{asset('storage/oficios/147_DAAD_MarciaAntuanetteLeonEulogio.pdf')}}" target="_blank" class="enlacesNormativa">Descargar documento</a></p>  
          <img src="{{asset('storage/images/147_DAAD_MarciaAntuanetteLeonEulogio.png')}}" alt=" ">
        </div>
