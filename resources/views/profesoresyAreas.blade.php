            ...
            <div id="professor-description" class="row mb-4 p-5">
                ...
                <div class="row col-12 col-sm-12 mt-2 mb-4">
                    ...
                    <div class="col-12 col-sm-8" id="contTablaIzq">
                        ...
                        <a class="btn btn-primary rounded-pill" id="botonesGeneral" href="recursosNaturales"
                            role="button">Conocer más</a>
                    </div>
                </div>
                ...
                <div class="row col-12 col-sm-12 mt-2 mb-4">
                    ...
                    <div class="col-12 col-sm-8" id="contTablaIzq">
                        ...
                        <br><br>
                        <a class="btn btn-primary rounded-pill" id="botonesGeneral" href="saludAmbiental"
                            role="button">Conocer
                            más</a>
                    </div>
                </div>
