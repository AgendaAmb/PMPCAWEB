        ...
        <div id="professor-description" class="row mb-4 p-5 border">
            ...
            <div class="row col-12 col-sm-12 border  mt-2 mb-4">
                ...
                <div class="col-12 col-sm-8 border ">
                    ...
                    diferentes medios. Los datos obtenidos de este análisis permiten evaluar el impacto ambiental para establecer estrategias de prevención y remediación adecuadas. <br><br>
            ...
            <div class="row col-12 col-sm-12 border mt-2 mb-4">
                ...
                <div class="col-12 col-sm-8 border">
                    ...
                    temas prioritarios: las enfermedades emergentes y el cambio climático, la vulnerabilidad y la resiliencia ante desastres y los cambios ambientales en los sistemas socioecológicos. <br><br>
            ...
            <div class="row col-12 col-sm-12 border mt-2 mb-4">
                ...
                <div class="col-12 col-sm-8 border">
                    ...
                    nuevos materiales ambientales avanzados, así como el uso de fuentes alternas de energías y tecnologías para reducir los efectos de la contaminación ambiental. <br><br>
            ...
            <div class="row col-12 col-sm-12 border mt-2 mb-4">
                ...
                <div class="col-12 col-sm-8 border">
                    ...
                    biótica, estructura y variación de poblaciones y comunidades en relación con factores ambientales y con la perturbación natural y humana; evaluaciones experimentales en condiciones controladas, efectos del ambiente en la producción y repro-
                    ducción del ganado, y cambios ecofisiológicos en plantas silvestres y cultivadas debidos al cambio climático; el análisis de las relaciones recíprocas entre humanos y la biota, a través de los hechos, procesos, materiales recolectados, productos primarios y otras manifestaciones culturales; el análisis integral y comparativo de sistemas agrícolas y pecuarios, tradicionales y empresariales, que permite reconocer los factores que pueden estar limitando su estabilidad y productividad. <br><br>
            ...
            <div class="row col-12 col-sm-12 border mt-2 mb-4">
                ...
                <div class="col-12 col-sm-8 border">
                    ...
                    para asegurar el desarrollo sustentable a través de la participación comunitaria responsable. <br><br>
