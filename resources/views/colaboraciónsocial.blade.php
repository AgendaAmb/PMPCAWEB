...
<div id="p-container" class="container px-lg-8.5 px-md-5">
    ...
    <div id="professor-description" class="row mb-4 p-5">
        ...
        <div class="col-12 col-sm-12 mt-5">
            <div>
                <p>
                    La principal contribución social del Programa Multidisciplinario de Posgrado en Ciencias Ambientales (PMPCA) es
                    la formación de recursos humanos con capacidad de incidir de manera novedosa en la generación de conocimiento. 
                    Los estudiantes participan en el desarrollo de investigación científica de frontera y adquieren habilidades y 
