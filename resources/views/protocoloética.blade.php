        ...
        <div id="p-container" class="container px-lg-8.5 px-md-5">
            <div id="professor-description" class="row mb-4 p-5">
                ...
                <div class="col-12 col-sm-12">
                    <div id="contTablaIzq">
                        <p>
                            Para la Universidad Autónoma de San Luis Potosí, el conocimiento por sí mismo no produce cambios
                            si este no va acompañado de acciones que permitan un cierto grado de realización social de los
                            productos que genera la institución en respuesta a problemas concretos, para ello toma el
                            concepto de ética como párametro para formar profesionales que en el futuro dirigirán los
                            destinos de la sociedad, así como también hacia el interior de la institución, en el actuar de
