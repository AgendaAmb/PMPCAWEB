...
<div id="p-container" class="container px-lg-8.5 px-md-5">
    ...
    <div class="col-12 col-sm-9">
        ...
        <p>
            ...
            Teléfono: +52 (444) 817-3381 ext. 7206 <br>
            <a href="mailto:luis.bernal@uaslp.mx" style="color:rgb(0, 178, 227)">luis.bernal@uaslp.mx</a><br><br>
        </p>

        <div class="enlacesprof">
            <a target="_blank" href="http://ciep.ing.uaslp.mx/geologia/profesor.php?id=3130383733">Webpage</a>
            <a target="_blank" href="{{asset('storage/CV/Bernal_Jacome_LuisArmando.pdf')}}"><i>Curriculum vitae</i></a>
