...
<div id="p-container" class="container px-lg-8.5 px-md-5">
    ...
    <div class="col-12 col-sm-9">
        ...
        <p>
            ...
            Teléfono: +52 (444) 826-2300 ext. 6082 <br>
            <a href="mailto:gcastro@uaslp.mx" style="color:rgb(0, 178, 227)">gcastro@uaslp.mx</a><br><br>
        </p>

        <div class="enlacesprof">
            <a target="_blank" href="http://ciep.ing.uaslp.mx/minerales/profesor.php?id=3133323833">Webpage</a>
            <a target="_blank" href="{{asset('storage/CV/Castro_Larragoitia_GuillermoJavier.pdf')}}"><i>Curriculum vitae</i></a>
