...
<div id="p-container" class="container px-lg-8.5 px-md-5">
    ...
    <div class="col-12 col-sm-9">
        ...
        <div class="enlacesprof">
            ...
            <a href="#"><img src="{{asset('storage/images/orcid.png')}}" alt=""></a>
            <a href="#"> <img src="{{asset('storage/images/scopus.png')}}" alt=""></a>
        </div>
        </div>
    </div>
    </div>
        ...
        <div class="accordion-item">
          ...
          <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
            ...
            <div class="accordion-body">
              ...
              overriding our default variables. It's also worth noting that just about any HTML can go within the <br>
              <a href="#"> hola soy un enlace 2022</a>
