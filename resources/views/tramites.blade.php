                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse active show" aria-labelledby="headingTwo"
                            ...
                            <p><strong>1. Inscripción</strong><br>
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="/storage/pdf/1.1 F_Inscripcion_MCA.pdf"> 1.1 Formato de inscripción a la Maestría en Ciencias Ambientales </a>
                                </div>
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                            ...
                            <p><strong>4. Obtención de grado</strong><br>
                                ...
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        ...
                                        <div style="margin-left: 25px;">
                                            ...
                                            <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                                <a href="/storage/pdf/4.7.2 CartaAutorizacion_CoautoriaDirectorTesis.docx">4.7.2 Carta de autorización para el autoarchivo de una tesis en el repositorio institucional de la UASLP en coautoría con el director de tesis</a>
                                            </div>
                                            <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                                <a href="/storage/pdf/4.7.3 CartaAutorizacion_Coparticipacion.docx">4.7.3 Carta de autorización para el autoarchivo de una tesis en el repositorio institucional de la UASLP en coparticipación con otra institución</a>
                                            </div>
                                            <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                                <a href="/storage/pdf/4.7.4 SolicitudEmbargo.docx">4.7.4 Solicitud de embargo del repositorio institucional de la UASLP</a>
                                            </div>
                                       </div>
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="/storage/pdf/4.8 RecepcionTesis.pdf"> 4.8 Formato para registro de línea de investigación de tesis</a>
                                </div>
                            </p>
                            <br><br>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                            ...
                            <div class="accordion-body" id="accordionTextM"><br>
                                <p><strong>1. Inscripción</strong><br>
                                    <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="/storage/pdf/1.2 F_Inscripcion_ENREM.pdf"> 1.2 Formato de inscripción a la Maestría en Ciencias Ambientales (doble titulación) </a>
                                    </div>
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="/storage/pdf/1.4 F_AltasBajas.pdf"> 1.4 Formato de altas y bajas </a>
                                </div>
                            ...
                            <p><strong>2. Tesis y comité tutorial</strong><br>
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="/storage/pdf/2.2 AsignacionDirectorTesis.pdf"> 2.2 Formato para asignación de director de tesis del programa de Maestría en Ciencias Ambientales (doble titulación) </a>
                                </div>
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="/storage/pdf/2.4 ComTutorialTesis.pdf"> 2.4 Formato para el registro de comité tutorial y título de tesis para el programa de Maestría en Ciencias Ambientales (doble titulación) </a>
                                </div>
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="/storage/pdf/2.6 CambioComiteTutorial.pdf"> 2.6 Formato para el cambio de comité tutorial </a>
                                </div>
                            ...
                            <p><strong>3. Reporte de calificaciones</strong><br>
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="/storage/pdf/3.2 ActaEvalTrabTesis.pdf"> 3.2 Acta de trabajo de tesis semestral para el programa de Maestría en Ciencias Ambientales (doble titulación)</a>
                                </div>
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="/storage/pdf/3.5 Calif_SemTesis.pdf"> 3.5 Formato para calificación de seminario de tesis para Maestría en Ciencias Ambientales (doble tiulación) </a>
                                </div>
                            </p>
                            <br><br>
                            <p><strong>4. Obtención de grado</strong><br>
                                ...
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="/storage/pdf/4.4 PortadaTesis.docx"> 4.4 Portada de tesis para Maestría en Ciencias Ambientales (doble titulación) </a>
                                </div>
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="/storage/pdf/4.6 ENREM_Poster.pptx"> 4.6 Poster de tesis para Maestría en Ciencias Ambientales (doble titulación) </a>
                                </div>
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        4.7 Cartas para publicación de tesis en repositorio institucional<br>
                                        <div style="margin-left: 25px;">
                ...
                <div class="accordion-item">
                    <div class="accordion-item">
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                            ...
                            <p><strong>2. Tesis y comité tutorial</strong><br>
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="/storage/pdf/2.5 ComTutorialTesis.pdf"> 2.5 Formato para el registro de comité tutorial y título de tesis para el programa de Doctorado en Ciencias Ambientales </a>
                                </div>
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="/storage/pdf/2.6 CambioComiteTutorial.pdf"> 2.6 Formato para el cambio de comité tutorial </a>
                                </div>
                            ...
                            <p><strong>3. Reporte de calificaciones</strong><br>
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="/storage/pdf/3.3 ActaEvalTrabTesis.pdf"> 3.3 Acta de trabajo de tesis semestral para el programa de Doctorado en Ciencias Ambientales </a>
                                </div>
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="/storage/pdf/3.4 Calif_SemTesis.pdf"> 3.4 Formato para calificación de seminario de tesis para Maestría y Doctorado en Ciencias Ambientales </a>
                                </div>
                            ...
                            <p><strong>4. Obtención de grado</strong><br>
                                ...
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="/storage/pdf/4.2 RequisitosEgreso.pdf"> 4.2 Formato de solicitud de aprobación de requisitos de egreso de alumnos del Doctorado en Ciencias Ambientales </a>
                                </div>
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="/storage/pdf/4.3_PortadaTesis.docx"> 4.3 Portada de tesis para Maestría y Doctorado en Ciencias Ambientales </a>
                                </div>
