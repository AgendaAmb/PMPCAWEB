                ...
                <div class="accordion-item">
                    <div class="accordion-item">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse active show" aria-labelledby="headingTwo"
                            ...
                            <p><strong>5. Egresados</strong><br>
                                ...
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="https://forms.office.com/r/6cR97YNELX" target="_blank"> 5.3 Encuesta básica de egresados  </a>
                                </div>
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="https://forms.office.com/r/tXsvWuvyf0"> 5.4 Encuesta para programa de egresados del PMPCA  </a>
                                </div>
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                            ...
                            <br><br>
                            <p><strong>6. Formatos Conahcyt</strong><br>
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                ...
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="https://conahcyt.mx/becas_posgrados/tramite-de-liberacion-de-beca/" target="_blank"> 6.3 Liberación de beca Conahcyt</a>
                                </div>
                            </p>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                            ...
                            <p><strong>4. Obtención de grado</strong><br>
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="{{asset('storage/pdf/4.1a SolicitudExamenJur.pdf')}}" target="_blank"> 4.1 Anexo a la solicitud oficial de aprobación de examen de grado y jurado de examen </a>
                                </div>
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                            ...
                            <p><strong>5. Egresados</strong><br>
                                ...
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="https://forms.office.com/r/tXsvWuvyf0" target="_blank"> 5.4 Encuesta para programa de egresados del PMPCA  </a>
                                </div>
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="https://forms.office.com/r/E8GF1BBTbR" target="_blank"> 5.5 Registro de artículos </a>
                                </div>
                            ...
                            <p><strong>6. Formatos Conahcyt</strong><br>
                                ...
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="{{asset('storage/pdf/6.2 FormatoRetribucionSocial_Anexo.pdf')}}" target="_blank"> 6.3 Actividades de retribución social + anexo</a>
                                </div>
                                <div class="col-12 col-sm-12 my-4" id="enlacetramites">
                                        <a href="https://conahcyt.mx/becas_posgrados/tramite-de-liberacion-de-beca/" target="_blank"> 6.3 Liberación de beca Conahcyt</a>
                                </div>
